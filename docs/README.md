...
欢迎来到 MixRead 文档中心！本目录包含项目的所有文档，按功能分类组织。

## 📚 文档结构

### 🚀 [01-guides](01-guides/) - 快速开始和操作指南
快速上手和日常操作的必读文档。

- **[getting-started.md](01-guides/getting-started.md)** - 新用户入门指南，包含环境设置、后端启动、扩展加载等
- **[installation-guide.md](01-guides/installation-guide.md)** - 完整的安装和测试流程（15分钟快速安装）
- **[extension-reload.md](01-guides/extension-reload.md)** - Chrome 扩展重新加载指南（修改代码后必读）
- **[vscode-setup.md](01-guides/vscode-setup.md)** - VSCode 开发环境完整配置指南
...
- **[quick-debug.md](02-development/debugging/quick-debug.md)** - 5分钟快速调试清单（快速定位问题根源）
- **[extension-testing.md](02-development/debugging/extension-testing.md)** - Chrome 扩展自动化测试真实方案和对比

### ✨ [03-features](03-features/) - 功能文档
已实现或计划中的功能说明。

- **[chinese-translation.md](03-features/chinese-translation.md)** - 中文翻译功能实现完成说明
...
项目根目录的 [README.md](../README.md) 包含项目的主要说明和快速概览。
